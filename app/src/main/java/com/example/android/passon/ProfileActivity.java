        ...
        if (mChildEventListenerProfile == null) {
            ...
            mChildEventListenerProfile = new ChildEventListener() {//working with db after authentication
                ...
                public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                    ...
                    chats.add(chatHead);
                    Log.i("onitemadded", "standpoint pr105");
...
//                        }                    }
                        ...
                        Main2Activity.mUserDatabaseReference.orderByChild("userId").equalTo(Main2Activity.mUserId).addChildEventListener(mChildEventListenerProfileTest);
                        if (mChildEventListenerProfileTest != null) {
...
//                        Main2Activity.mUserDatabaseReference.orderByChild("userId").equalTo(Main2Activity.mUserId).getRef().child("connectionRequestUsers").removeEventListener(mChildEventListenerProfile);
                        Main2Activity.mUserDatabaseReference.orderByChild("userId").equalTo(Main2Activity.mUserId).removeEventListener(mChildEventListenerProfileTest);
